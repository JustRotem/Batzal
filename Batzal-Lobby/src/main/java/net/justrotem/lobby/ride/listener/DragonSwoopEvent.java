...
public class DragonSwoopEvent extends EntityTargetLivingEntityEvent {
     ...
     *
     * @return {@link Vector} to denote additional velocity
     */
     ...
     *
     * @param velocity {@link Vector} for additional velocity
     */
    ...
    /**
     * Get the {@link EnderDragon} that is launching an entity
     *
