...
import net.justrotem.game.skins.SkinManager;
import net.justrotem.game.sql.AsyncNickDataManager;
...
public class NickManager implements Listener {
    ...
    public static void setNick(Player player, String nickname, String skin, String rank) {
        ...
        if (!(rank == null || rank.isEmpty())) LuckPermsManager.setPrefix(player, LuckPermsManager.getLegacyGroupPrefix(rank), 100);
